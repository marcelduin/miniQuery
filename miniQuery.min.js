...
_$.prototype={each:function(a){for(var b=0;b<this.length;b++)a.call(this[b]);return this},remove:function(){this.each(function(){this.parentNode.removeChild(this)});return this},replaceWith:function(a){var b=this;b[0]&&(a.each?a.each(function(){b[0].parentNode.insertBefore(this,b[0])}):b[0].parentNode.insertBefore(a,b[0]),b.remove());return this},appendTo:function(a){a=a.length?a[0]:a;this.each(function(){a.appendChild(this)});return this},parent:function(){var a=[];this.each(function(){0>a.indexOf(this.parentNode)&&
a.push(this.parentNode)});return new _$(a)},children:function(a){a=a||"*";var b=[];this.each(function(){for(var c=this.querySelectorAll(a),d=0;d<c.length;d++)c[d].parentNode==this&&b.push(c[d])});return new _$(b)},find:function(a){return new _$(a,this[0])},filter:function(a,b){a=_getEls(a);return new _$([].filter.call(this,function(c){for(var d=0;d<a.length;d++)if(a[d]==c)return!b;return!!b}))},not:function(a){return this.filter(a,!0)},eq:function(a){return new _$(this[a])},has:function(a){for(var b=
